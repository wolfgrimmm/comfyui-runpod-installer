...
REM Check if ComfyUI and venv already exist
if exist "ComfyUI\venv" (
    echo Existing ComfyUI installation detected. Proceeding with update...
    echo.
    cd ComfyUI
...
pip install "triton-windows<3.5" huggingface_hub hf_transfer hf_xet accelerate diffusers onnxruntime-gpu==1.22.0 piexif requests ultralytics==8.3.197 --upgrade
